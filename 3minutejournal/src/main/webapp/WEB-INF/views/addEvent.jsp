...
<div class="container">
    ...
    <p>
    	...
    	<form:textarea path="description" id="description" rows="30" cols="110" />
    ...
    <p>
    	...
    	<form:select path="duration.id" items="${durations}" id="duration" itemValue="id" itemLabel="duration" />
   		<div style="text-align: center;">
    ...
    <p>
    	...
    	<form:select path="feeling.id" items="${feelings}" id="feeling" itemValue="id" itemLabel="feeling" />
    	<div style="text-align: center;">
    ...
    <p>
    	...
    	<form:select path="type.id" items="${types}" id="type" itemValue="id" itemLabel="type" />
    	<div style="text-align: center;">
    ...
    <p>
    	...
    	<form:select path="frequency.id" items="${frequencies}" id="frequency" itemValue="id" itemLabel="frequency" />
    	<div style="text-align: center;">
    ...
    <p>
    	...
    	<form:input path="date" id="date" size="107"/>
    	<div style="text-align: center;">
